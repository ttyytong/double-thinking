...
def main():
    ...
    parser.add_argument("--from_pretrained", type=str, default="/hdd0/tyt/checkpoints/merged_lora", help='pretrained ckpt')
    ...
    model = model.eval()
    model_args.save = '/hdd0/tyt/checkpoints/merged_model_{}'.format(model_args.eva_args["image_size"][0])
